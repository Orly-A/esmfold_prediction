...
def split_data(X, y, groups, full_tab_with_clusters):
    ...
    train_set.to_pickle(PATH + "esmfold_prediction/train_set_c0.3.pkl")
    hold_out_set.to_pickle(PATH + "esmfold_prediction/hold_out_set_c0.3.pkl")
...
#    full_tab_with_clusters = pd.merge(full_tab_for_embed, cluster_tab, on="code", how="outer")
    full_tab_with_clusters = pd.read_pickle("/vol/ek/Home/orlyl02/working_dir/oligopred/esmfold_prediction/esm_tab.pkl")
